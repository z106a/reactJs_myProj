...
var _serverCreateStore = __webpack_require__(8);

var _serverCreateStore2 = _interopRequireDefault(_serverCreateStore);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var app = (0, _express2.default)();
var port = 3000; // this must be 3000, otherwise google auth callback won't work.
...
app.get('*', function (req, res) {
    ...
    var store = (0, _serverCreateStore2.default)(req); // to get cookies from request.
        ...
        value: function head() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'title',
                    null,
                    this.props.users.length + ' Users Finded'
                ),
...
var AdminsListPage = function (_React$Component) {
    ...
    _createClass(AdminsListPage, [{
        ...
        key: 'renderUsers',
        value: function renderUsers() {
            return this.props.admins.map(function (user) {
                return _react2.default.createElement(
                    'li',
                    { key: user.id },
                    user.name
